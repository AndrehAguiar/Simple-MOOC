# Generated by Django 3.0.6 on 2020-05-13 05:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aula', to='courses.Course', verbose_name='Curso')),
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materiais', to='courses.Lesson', verbose_name='Aula')),
            ],
            options={
