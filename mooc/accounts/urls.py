...
app_name = 'accounts'
urlpatterns = [
    path('', dashboard, name='dashboard'), path('entrar/',
    ...
    path('redefine-senha/', password_reset, name='password_reset'),
    re_path(r'confirma-nova-senha/(?P<key>\w+)/$', password_reset_confirm, name='password_reset_confirm'),
